...
class Tang_dan_so_luong_cot(Generator):
    def __init__(self, DATABASE_PATH, SAVE_TYPE, DATA_OR_PATH, LABEL, INTEREST, NUM_CYCLE, MAX_CYCLE, MIN_CYCLE, FIELDS, NUM_CHILD_PROCESS, FILTERS, DIV_WGT_BY_MC, TARGET, MODE=0, TMP_STRG_SIZE=10000, PERIODIC_SAVE_TIME=1800, MAX_OPERAND_PER_FORMULA=0, numerator_condition=True):
        super().__init__(DATABASE_PATH, SAVE_TYPE, DATA_OR_PATH, LABEL, INTEREST, NUM_CYCLE, MAX_CYCLE, MIN_CYCLE, FIELDS, NUM_CHILD_PROCESS, FILTERS, DIV_WGT_BY_MC, TARGET, MODE, TMP_STRG_SIZE, PERIODIC_SAVE_TIME, MAX_OPERAND_PER_FORMULA, numerator_condition)
